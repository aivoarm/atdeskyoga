...
import { share,logoLinkedin,  logoVimeo, logoGoogleplus, logoTwitter, logoFacebook } from "ionicons/icons"
  ...
  return(
    <>
      ...
      <IonFab slot="fixed" vertical="bottom" horizontal="end">
        ...
        <IonFabList side="top">
          <IonFabButton color="linkedin" onClick={() => openSocial('Linkedin')}>
