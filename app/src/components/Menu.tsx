...
import { play, calendar, contacts, hammer, help, informationCircle, logIn, logOut, map, person, personAdd } from 'ionicons/icons';
...
const routes = {
  appPages: [
    { title: 'Begin', path: '/tabs/schedule', icon: play },
    { title: 'About', path: '/tabs/about', icon: informationCircle },
    { title: 'Gurus', path: '/tabs/speakers', icon: contacts }
