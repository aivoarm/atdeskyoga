        ...
        <IonSlides ref={slideRef} onIonSlideWillChange={handleSlideChangeStart} pager={false}>
          <IonSlide>
            ...
            <h2 className="slide-title">
              Welcome to <b>Remote yoga</b>
            </h2>
            <p>
              The <b>At desk yoga</b> it tool to stay close to your guru.
            </p>
          </IonSlide>

          <IonSlide>
            <img src="assets/img/ica-slidebox-img-2.png" alt="" className="slide-image" />
            <h2 className="slide-title">Add to your calendar</h2>
            <p>
              <b>At desk yoga</b> helps you to love your body. Ask your teacher for a proper schedule 
            </p>
          </IonSlide>

          <IonSlide>
            <img src="assets/img/ica-slidebox-img-3.png" alt="" className="slide-image" />
            <h2 className="slide-title">Make your favourite list</h2>
            <p>
              <b>At desk yoga</b> Asanas that help you the most. Ask your guru more details
            </p>
          </IonSlide>

          <IonSlide>
            <img src="assets/img/ica-slidebox-img-4.png" alt="" className="slide-image" />
            <h2 className="slide-title">Filter your guru classes</h2>
            <p>
              <b>Read? let's go!</b> 
            </p>
